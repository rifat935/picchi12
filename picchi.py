#!/usr/bin/python2
#coding=utf-8
#Codded By Picchi Rifat
#Editing My Script Will Not Make You A Coder
#Facebook      :picchi.rifat.9
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:Magibaz_Picchi
	    time.sleep(1)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;95m👉 : \033[1;95mPicchi' ) 
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://facebook.com/groups/3190794814378944/')
